...
class Program
{
    ...
    static void Main()
    {
        ...
        if (NtQuerySystemInformation(SystemHandleInformation, ptr, length, ref length) != 0)
        {
            Console.WriteLine("Erreur lors de la récupération des handles.");
            return;
        }
        ...
        for (int i = 0; i < handleCount; i++)
        {
            ...
            ushort handle = Marshal.ReadInt16(handlePtr, 8);
